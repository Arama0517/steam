...
_ENCRYPTEDAPPTICKET = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name='EncryptedAppTicket.ticket_version_no',
            index=0,
            number=1,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='EncryptedAppTicket.crc_encryptedticket',
            index=1,
            number=2,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='EncryptedAppTicket.cb_encrypteduserdata',
            index=2,
            number=3,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='EncryptedAppTicket.cb_encrypted_appownershipticket',
            index=3,
            number=4,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='EncryptedAppTicket.encrypted_ticket',
            index=4,
            number=5,
            type=12,
            cpp_type=9,
...
EncryptedAppTicket = _reflection.GeneratedProtocolMessageType(
    'EncryptedAppTicket',
    (_message.Message,),
    {
