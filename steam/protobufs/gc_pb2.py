...
_CMSGPROTOBUFHEADER = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name='foobar.CMsgProtoBufHeader.client_steam_id',
            index=0,
            number=1,
            type=6,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='foobar.CMsgProtoBufHeader.client_session_id',
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='source_app_id',
            full_name='foobar.CMsgProtoBufHeader.source_app_id',
            index=2,
            number=3,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name='job_id_source',
            full_name='foobar.CMsgProtoBufHeader.job_id_source',
            index=3,
            number=10,
            type=6,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name='job_id_target',
            full_name='foobar.CMsgProtoBufHeader.job_id_target',
            index=4,
            number=11,
            type=6,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='foobar.CMsgProtoBufHeader.target_job_name',
            index=5,
            number=12,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='eresult',
            full_name='foobar.CMsgProtoBufHeader.eresult',
            index=6,
            number=13,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='error_message',
            full_name='foobar.CMsgProtoBufHeader.error_message',
            index=7,
            number=14,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='gc_msg_src',
            full_name='foobar.CMsgProtoBufHeader.gc_msg_src',
            index=8,
            number=200,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='foobar.CMsgProtoBufHeader.gc_dir_index_source',
            index=9,
            number=201,
            type=13,
            cpp_type=3,
