...
_OFFLINE_TICKET = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name='Offline_Ticket.encrypted_ticket',
            index=0,
            number=1,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='signature',
            full_name='Offline_Ticket.signature',
            index=1,
            number=2,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='salt1',
            full_name='Offline_Ticket.salt1',
            index=3,
            number=4,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='salt2',
            full_name='Offline_Ticket.salt2',
            index=5,
            number=6,
            type=12,
            cpp_type=9,
...
Offline_Ticket = _reflection.GeneratedProtocolMessageType(
    'Offline_Ticket',
    (_message.Message,),
    {
