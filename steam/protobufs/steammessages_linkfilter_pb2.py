...
_CCOMMUNITY_GETLINKFILTERHASHPREFIXES_REQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='hit_type',
            full_name='CCommunity_GetLinkFilterHashPrefixes_Request.hit_type',
            index=0,
            number=1,
            type=13,
            cpp_type=3,
            ...
            serialized_options=b'\202\265\0301The retrieved hits will be filtered to this type.',
            file=DESCRIPTOR,
            create_key=_descriptor._internal_create_key,
        ),
        _descriptor.FieldDescriptor(
            name='count',
            full_name='CCommunity_GetLinkFilterHashPrefixes_Request.count',
            index=1,
            number=2,
            type=13,
            cpp_type=3,
            ...
            is_extension=False,
            extension_scope=None,
            serialized_options=b'\202\265\030IThe number of hits to retrieve in a single batch. Specify 0 for no limit.',
            file=DESCRIPTOR,
            create_key=_descriptor._internal_create_key,
        ),
        _descriptor.FieldDescriptor(
            name='start',
            full_name='CCommunity_GetLinkFilterHashPrefixes_Request.start',
            index=2,
            number=3,
            type=4,
            cpp_type=4,
            ...
            is_extension=False,
            extension_scope=None,
            serialized_options=b'\202\265\0303The starting count when retrieving hits in batches.',
            file=DESCRIPTOR,
            create_key=_descriptor._internal_create_key,
        ),
    ],
...
_CCOMMUNITY_GETLINKFILTERHASHPREFIXES_RESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='hash_prefixes',
            full_name='CCommunity_GetLinkFilterHashPrefixes_Response.hash_prefixes',
            index=0,
            number=1,
            type=13,
            cpp_type=3,
            ...
            is_extension=False,
            extension_scope=None,
            serialized_options=b'\202\265\030;The first 32 bits of the SHA1 hashes of each hit requested.',
            file=DESCRIPTOR,
            create_key=_descriptor._internal_create_key,
        ),
    ],
...
_CCOMMUNITY_GETLINKFILTERHASHES_REQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='hit_type',
            full_name='CCommunity_GetLinkFilterHashes_Request.hit_type',
            index=0,
            number=1,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name='count',
            full_name='CCommunity_GetLinkFilterHashes_Request.count',
            index=1,
            number=2,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name='start',
            full_name='CCommunity_GetLinkFilterHashes_Request.start',
            index=2,
            number=3,
            type=4,
            cpp_type=4,
...
_CCOMMUNITY_GETLINKFILTERHASHES_RESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='hashes',
            full_name='CCommunity_GetLinkFilterHashes_Response.hashes',
            index=0,
            number=1,
            type=12,
            cpp_type=9,
            ...
            is_extension=False,
            extension_scope=None,
            serialized_options=b'\202\265\030+A list of hashes returned from our request.',
            file=DESCRIPTOR,
            create_key=_descriptor._internal_create_key,
        ),
    ],
...
_CCOMMUNITY_GETLINKFILTERLISTVERSION_REQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='hit_type',
            full_name='CCommunity_GetLinkFilterListVersion_Request.hit_type',
            index=0,
            number=1,
            type=13,
            cpp_type=3,
            ...
            is_extension=False,
            extension_scope=None,
            serialized_options=b"\202\265\030;The version hashes for this type's chunks will be returned.",
            file=DESCRIPTOR,
            create_key=_descriptor._internal_create_key,
        ),
    ],
...
_CCOMMUNITY_GETLINKFILTERLISTVERSION_RESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='version',
            full_name='CCommunity_GetLinkFilterListVersion_Response.version',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
            ...
            is_extension=False,
            extension_scope=None,
            serialized_options=b'\202\265\0301A hash built using the IDs of the contained hits.',
            file=DESCRIPTOR,
            create_key=_descriptor._internal_create_key,
        ),
        _descriptor.FieldDescriptor(
            name='count',
            full_name='CCommunity_GetLinkFilterListVersion_Response.count',
            index=1,
            number=2,
            type=4,
            cpp_type=4,
            ...
            is_extension=False,
            extension_scope=None,
            serialized_options=b'\202\265\030\037The number of hits of this type',
            file=DESCRIPTOR,
            create_key=_descriptor._internal_create_key,
        ),
    ],
...
DESCRIPTOR.message_types_by_name['CCommunity_GetLinkFilterHashPrefixes_Request'] = (
    _CCOMMUNITY_GETLINKFILTERHASHPREFIXES_REQUEST
)
DESCRIPTOR.message_types_by_name['CCommunity_GetLinkFilterHashPrefixes_Response'] = (
    _CCOMMUNITY_GETLINKFILTERHASHPREFIXES_RESPONSE
)
DESCRIPTOR.message_types_by_name['CCommunity_GetLinkFilterHashes_Request'] = (
    _CCOMMUNITY_GETLINKFILTERHASHES_REQUEST
)
DESCRIPTOR.message_types_by_name['CCommunity_GetLinkFilterHashes_Response'] = (
    _CCOMMUNITY_GETLINKFILTERHASHES_RESPONSE
)
DESCRIPTOR.message_types_by_name['CCommunity_GetLinkFilterListVersion_Request'] = (
    _CCOMMUNITY_GETLINKFILTERLISTVERSION_REQUEST
)
DESCRIPTOR.message_types_by_name['CCommunity_GetLinkFilterListVersion_Response'] = (
    _CCOMMUNITY_GETLINKFILTERLISTVERSION_RESPONSE
)
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

CCommunity_GetLinkFilterHashPrefixes_Request = _reflection.GeneratedProtocolMessageType(
...
CCommunity_GetLinkFilterHashPrefixes_Response = _reflection.GeneratedProtocolMessageType(
...
CCommunity_GetLinkFilterHashes_Request = _reflection.GeneratedProtocolMessageType(
...
CCommunity_GetLinkFilterHashes_Response = _reflection.GeneratedProtocolMessageType(
...
CCommunity_GetLinkFilterListVersion_Request = _reflection.GeneratedProtocolMessageType(
...
CCommunity_GetLinkFilterListVersion_Response = _reflection.GeneratedProtocolMessageType(
...
_CCOMMUNITY_GETLINKFILTERHASHPREFIXES_REQUEST.fields_by_name['hit_type']._options = None
_CCOMMUNITY_GETLINKFILTERHASHPREFIXES_REQUEST.fields_by_name['count']._options = None
_CCOMMUNITY_GETLINKFILTERHASHPREFIXES_REQUEST.fields_by_name['start']._options = None
_CCOMMUNITY_GETLINKFILTERHASHPREFIXES_RESPONSE.fields_by_name['hash_prefixes']._options = None
_CCOMMUNITY_GETLINKFILTERHASHES_REQUEST.fields_by_name['hit_type']._options = None
_CCOMMUNITY_GETLINKFILTERHASHES_REQUEST.fields_by_name['count']._options = None
_CCOMMUNITY_GETLINKFILTERHASHES_REQUEST.fields_by_name['start']._options = None
_CCOMMUNITY_GETLINKFILTERHASHES_RESPONSE.fields_by_name['hashes']._options = None
_CCOMMUNITY_GETLINKFILTERLISTVERSION_REQUEST.fields_by_name['hit_type']._options = None
_CCOMMUNITY_GETLINKFILTERLISTVERSION_RESPONSE.fields_by_name['version']._options = None
_CCOMMUNITY_GETLINKFILTERLISTVERSION_RESPONSE.fields_by_name['count']._options = None
...
DESCRIPTOR.services_by_name['CommunityLinkFilter'] = _COMMUNITYLINKFILTER

CommunityLinkFilter = service_reflection.GeneratedServiceType(
    'CommunityLinkFilter',
    (_service.Service,),
    dict(DESCRIPTOR=_COMMUNITYLINKFILTER, __module__='steammessages_linkfilter_pb2'),
)

CommunityLinkFilter_Stub = service_reflection.GeneratedServiceStubType(
