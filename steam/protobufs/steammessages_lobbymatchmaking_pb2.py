...
_ELOBBYSTATUS = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name='k_ELobbyStatusDoesNotExist',
            index=2,
            number=2,
            serialized_options=None,
            type=None,
...
_LOBBYMATCHMAKINGLEGACY_GETLOBBYSTATUS_REQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='app_id',
            full_name='LobbyMatchmakingLegacy_GetLobbyStatus_Request.app_id',
            index=0,
            number=1,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name='steamid_lobby',
            full_name='LobbyMatchmakingLegacy_GetLobbyStatus_Request.steamid_lobby',
            index=1,
            number=2,
            type=6,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='LobbyMatchmakingLegacy_GetLobbyStatus_Request.claim_ownership',
            index=2,
            number=3,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='LobbyMatchmakingLegacy_GetLobbyStatus_Request.claim_membership',
            index=3,
            number=4,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name='version_num',
            full_name='LobbyMatchmakingLegacy_GetLobbyStatus_Request.version_num',
            index=4,
            number=5,
            type=13,
            cpp_type=3,
...
_LOBBYMATCHMAKINGLEGACY_GETLOBBYSTATUS_RESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='app_id',
            full_name='LobbyMatchmakingLegacy_GetLobbyStatus_Response.app_id',
            index=0,
            number=1,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name='steamid_lobby',
            full_name='LobbyMatchmakingLegacy_GetLobbyStatus_Response.steamid_lobby',
            index=1,
            number=2,
            type=6,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name='lobby_status',
            full_name='LobbyMatchmakingLegacy_GetLobbyStatus_Response.lobby_status',
            index=2,
            number=3,
            type=14,
            cpp_type=8,
...
_LOBBYMATCHMAKINGLEGACY_GETLOBBYSTATUS_RESPONSE.fields_by_name[
    'lobby_status'
].enum_type = _ELOBBYSTATUS
DESCRIPTOR.message_types_by_name['LobbyMatchmakingLegacy_GetLobbyStatus_Request'] = (
    _LOBBYMATCHMAKINGLEGACY_GETLOBBYSTATUS_REQUEST
)
DESCRIPTOR.message_types_by_name['LobbyMatchmakingLegacy_GetLobbyStatus_Response'] = (
    _LOBBYMATCHMAKINGLEGACY_GETLOBBYSTATUS_RESPONSE
)
DESCRIPTOR.enum_types_by_name['ELobbyStatus'] = _ELOBBYSTATUS
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

LobbyMatchmakingLegacy_GetLobbyStatus_Request = _reflection.GeneratedProtocolMessageType(
...
LobbyMatchmakingLegacy_GetLobbyStatus_Response = _reflection.GeneratedProtocolMessageType(
...
LobbyMatchmakingLegacy = service_reflection.GeneratedServiceType(
...
LobbyMatchmakingLegacy_Stub = service_reflection.GeneratedServiceStubType(
