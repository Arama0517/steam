...
_CECONMARKET_ISMARKETPLACEALLOWED_REQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='webcookie',
            full_name='CEconMarket_IsMarketplaceAllowed_Request.webcookie',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
            ...
            serialized_options=b"\202\265\030+The user's Steam Guard machine auth cookie.",
            file=DESCRIPTOR,
            create_key=_descriptor._internal_create_key,
        ),
    ],
...
_CECONMARKET_ISMARKETPLACEALLOWED_RESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='allowed',
            full_name='CEconMarket_IsMarketplaceAllowed_Response.allowed',
            index=0,
            number=1,
            type=8,
            cpp_type=7,
            ...
            is_extension=False,
            extension_scope=None,
            serialized_options=b'\202\265\0304Whether or not the user is allowed to use the market',
            file=DESCRIPTOR,
            create_key=_descriptor._internal_create_key,
        ),
        _descriptor.FieldDescriptor(
            name='reason',
            full_name='CEconMarket_IsMarketplaceAllowed_Response.reason',
            index=1,
            number=2,
            type=13,
            cpp_type=3,
            ...
            is_extension=False,
            extension_scope=None,
            serialized_options=b"\202\265\0307The reason the user can't use the market, if applicable",
            file=DESCRIPTOR,
            create_key=_descriptor._internal_create_key,
        ),
        _descriptor.FieldDescriptor(
            name='allowed_at_time',
            full_name='CEconMarket_IsMarketplaceAllowed_Response.allowed_at_time',
            index=2,
            number=3,
            type=13,
            cpp_type=3,
            ...
            is_extension=False,
            extension_scope=None,
            serialized_options=b'\202\265\0303The time the user will be allowed to use the market',
            file=DESCRIPTOR,
            create_key=_descriptor._internal_create_key,
        ),
        _descriptor.FieldDescriptor(
            name='steamguard_required_days',
            full_name='CEconMarket_IsMarketplaceAllowed_Response.steamguard_required_days',
            index=3,
            number=4,
            type=13,
            cpp_type=3,
            ...
            is_extension=False,
            extension_scope=None,
            serialized_options=b'\202\265\030^The number of days any user is required to have had Steam Guard before they can use the market',
            file=DESCRIPTOR,
            create_key=_descriptor._internal_create_key,
        ),
        _descriptor.FieldDescriptor(
            name='forms_requested',
            full_name='CEconMarket_IsMarketplaceAllowed_Response.forms_requested',
            index=4,
            number=7,
            type=8,
            cpp_type=7,
            ...
            is_extension=False,
            extension_scope=None,
            serialized_options=b"\202\265\030:Whether or not we've requested the user fill out tax forms",
            file=DESCRIPTOR,
            create_key=_descriptor._internal_create_key,
        ),
        _descriptor.FieldDescriptor(
            name='forms_require_verification',
            full_name='CEconMarket_IsMarketplaceAllowed_Response.forms_require_verification',
            index=5,
            number=8,
            type=8,
            cpp_type=7,
            ...
            is_extension=False,
            extension_scope=None,
            serialized_options=b"\202\265\030@True if we've received forms but they require verification first",
            file=DESCRIPTOR,
            create_key=_descriptor._internal_create_key,
        ),
        _descriptor.FieldDescriptor(
            name='new_device_cooldown_days',
            full_name='CEconMarket_IsMarketplaceAllowed_Response.new_device_cooldown_days',
            index=6,
            number=9,
            type=13,
            cpp_type=3,
            ...
            is_extension=False,
            extension_scope=None,
            serialized_options=b'\202\265\030mThe number of days after initial device authorization a user must wait before using the market on that device',
            file=DESCRIPTOR,
            create_key=_descriptor._internal_create_key,
        ),
    ],
...
DESCRIPTOR.message_types_by_name['CEconMarket_IsMarketplaceAllowed_Request'] = (
    _CECONMARKET_ISMARKETPLACEALLOWED_REQUEST
)
DESCRIPTOR.message_types_by_name['CEconMarket_IsMarketplaceAllowed_Response'] = (
    _CECONMARKET_ISMARKETPLACEALLOWED_RESPONSE
)
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

CEconMarket_IsMarketplaceAllowed_Request = _reflection.GeneratedProtocolMessageType(
...
CEconMarket_IsMarketplaceAllowed_Response = _reflection.GeneratedProtocolMessageType(
...
_CECONMARKET_ISMARKETPLACEALLOWED_RESPONSE.fields_by_name[
...
EconMarket = service_reflection.GeneratedServiceType(
    'EconMarket',
    (_service.Service,),
    dict(DESCRIPTOR=_ECONMARKET, __module__='steammessages_market_pb2'),
)

EconMarket_Stub = service_reflection.GeneratedServiceStubType(
    'EconMarket_Stub',
    (EconMarket,),
    dict(DESCRIPTOR=_ECONMARKET, __module__='steammessages_market_pb2'),
)
