...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        ...
        offline__ticket__pb2.DESCRIPTOR,
    ],
)
...
_COFFLINE_GETOFFLINELOGONTICKET_REQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='priority',
            full_name='COffline_GetOfflineLogonTicket_Request.priority',
            index=0,
            number=1,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='COffline_GetOfflineLogonTicket_Request.perform_encryption',
            index=1,
            number=2,
            type=8,
            cpp_type=7,
...
_COFFLINE_GETOFFLINELOGONTICKET_RESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='serialized_ticket',
            full_name='COffline_GetOfflineLogonTicket_Response.serialized_ticket',
            index=0,
            number=1,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='signature',
            full_name='COffline_GetOfflineLogonTicket_Response.signature',
            index=1,
            number=2,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='COffline_GetOfflineLogonTicket_Response.encrypted_ticket',
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
_COFFLINE_OFFLINELOGONTICKET = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='accountid',
            full_name='COffline_OfflineLogonTicket.accountid',
            index=0,
            number=1,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='COffline_OfflineLogonTicket.rtime32_creation_time',
            index=1,
            number=2,
            type=7,
            cpp_type=3,
...
_COFFLINE_GETUNSIGNEDOFFLINELOGONTICKET_RESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='ticket',
            full_name='COffline_GetUnsignedOfflineLogonTicket_Response.ticket',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_COFFLINE_GETOFFLINELOGONTICKET_RESPONSE.fields_by_name[
    'encrypted_ticket'
].message_type = offline__ticket__pb2._OFFLINE_TICKET
_COFFLINE_GETUNSIGNEDOFFLINELOGONTICKET_RESPONSE.fields_by_name[
    'ticket'
].message_type = _COFFLINE_OFFLINELOGONTICKET
DESCRIPTOR.message_types_by_name['COffline_GetOfflineLogonTicket_Request'] = (
    _COFFLINE_GETOFFLINELOGONTICKET_REQUEST
)
DESCRIPTOR.message_types_by_name['COffline_GetOfflineLogonTicket_Response'] = (
    _COFFLINE_GETOFFLINELOGONTICKET_RESPONSE
)
DESCRIPTOR.message_types_by_name['COffline_GetUnsignedOfflineLogonTicket_Request'] = (
    _COFFLINE_GETUNSIGNEDOFFLINELOGONTICKET_REQUEST
)
DESCRIPTOR.message_types_by_name['COffline_OfflineLogonTicket'] = _COFFLINE_OFFLINELOGONTICKET
DESCRIPTOR.message_types_by_name['COffline_GetUnsignedOfflineLogonTicket_Response'] = (
    _COFFLINE_GETUNSIGNEDOFFLINELOGONTICKET_RESPONSE
)
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

COffline_GetOfflineLogonTicket_Request = _reflection.GeneratedProtocolMessageType(
...
COffline_GetOfflineLogonTicket_Response = _reflection.GeneratedProtocolMessageType(
...
COffline_GetUnsignedOfflineLogonTicket_Request = _reflection.GeneratedProtocolMessageType(
...
COffline_OfflineLogonTicket = _reflection.GeneratedProtocolMessageType(
...
COffline_GetUnsignedOfflineLogonTicket_Response = _reflection.GeneratedProtocolMessageType(
...
Offline = service_reflection.GeneratedServiceType(
    'Offline',
    (_service.Service,),
    dict(DESCRIPTOR=_OFFLINE, __module__='steammessages_offline_pb2'),
)

Offline_Stub = service_reflection.GeneratedServiceStubType(
    'Offline_Stub',
    (Offline,),
    dict(DESCRIPTOR=_OFFLINE, __module__='steammessages_offline_pb2'),
)
