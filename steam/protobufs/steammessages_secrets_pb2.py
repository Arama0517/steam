...
_EKEYESCROWUSAGE = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name='k_EKeyEscrowUsageStreamingDevice',
            index=0,
            number=0,
...
_CKEYESCROW_REQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name='CKeyEscrow_Request.rsa_oaep_sha_ticket',
            index=0,
            number=1,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='password',
            full_name='CKeyEscrow_Request.password',
            index=1,
            number=2,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='usage',
            full_name='CKeyEscrow_Request.usage',
            index=2,
            number=3,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='device_name',
            full_name='CKeyEscrow_Request.device_name',
            index=3,
            number=4,
            type=9,
            cpp_type=9,
...
_CKEYESCROW_TICKET = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='password',
            full_name='CKeyEscrow_Ticket.password',
            index=0,
            number=1,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='identifier',
            full_name='CKeyEscrow_Ticket.identifier',
            index=1,
            number=2,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name='payload',
            full_name='CKeyEscrow_Ticket.payload',
            index=2,
            number=3,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='timestamp',
            full_name='CKeyEscrow_Ticket.timestamp',
            index=3,
            number=4,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name='usage',
            full_name='CKeyEscrow_Ticket.usage',
            index=4,
            number=5,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='device_name',
            full_name='CKeyEscrow_Ticket.device_name',
            index=5,
            number=6,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='device_model',
            full_name='CKeyEscrow_Ticket.device_model',
            index=6,
            number=7,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='device_serial',
            full_name='CKeyEscrow_Ticket.device_serial',
            index=7,
            number=8,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='CKeyEscrow_Ticket.device_provisioning_id',
            index=8,
            number=9,
            type=13,
            cpp_type=3,
...
_CKEYESCROW_RESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='ticket',
            full_name='CKeyEscrow_Response.ticket',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
CKeyEscrow_Request = _reflection.GeneratedProtocolMessageType(
    'CKeyEscrow_Request',
    (_message.Message,),
    {
...
CKeyEscrow_Ticket = _reflection.GeneratedProtocolMessageType(
    'CKeyEscrow_Ticket',
    (_message.Message,),
    {
...
CKeyEscrow_Response = _reflection.GeneratedProtocolMessageType(
    'CKeyEscrow_Response',
    (_message.Message,),
    {
...
Secrets = service_reflection.GeneratedServiceType(
    'Secrets',
    (_service.Service,),
    dict(DESCRIPTOR=_SECRETS, __module__='steammessages_secrets_pb2'),
)

Secrets_Stub = service_reflection.GeneratedServiceStubType(
    'Secrets_Stub',
    (Secrets,),
    dict(DESCRIPTOR=_SECRETS, __module__='steammessages_secrets_pb2'),
)
