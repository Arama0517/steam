...
_CSHADER_REGISTERSHADER_REQUEST_SHADER = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='cache_key_sha',
            full_name='CShader_RegisterShader_Request.Shader.cache_key_sha',
            index=0,
            number=1,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='shader_code_sha',
            full_name='CShader_RegisterShader_Request.Shader.shader_code_sha',
            index=1,
            number=2,
            type=12,
            cpp_type=9,
...
_CSHADER_REGISTERSHADER_REQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='appid',
            full_name='CShader_RegisterShader_Request.appid',
            index=0,
            number=1,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name='gpu_desc',
            full_name='CShader_RegisterShader_Request.gpu_desc',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='driver_desc',
            full_name='CShader_RegisterShader_Request.driver_desc',
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='shaders',
            full_name='CShader_RegisterShader_Request.shaders',
            index=3,
            number=4,
            type=11,
            cpp_type=10,
    ...
    extensions=[],
    nested_types=[
        _CSHADER_REGISTERSHADER_REQUEST_SHADER,
    ],
    enum_types=[],
    serialized_options=None,
    is_extendable=False,
...
_CSHADER_REGISTERSHADER_RESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='requested_codeids',
            full_name='CShader_RegisterShader_Response.requested_codeids',
            index=0,
            number=1,
            type=13,
            cpp_type=3,
...
_CSHADER_SENDSHADER_REQUEST_SHADERCODE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='shader_code_sha',
            full_name='CShader_SendShader_Request.ShaderCode.shader_code_sha',
            index=0,
            number=1,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='shader_code',
            full_name='CShader_SendShader_Request.ShaderCode.shader_code',
            index=1,
            number=2,
            type=12,
            cpp_type=9,
...
_CSHADER_SENDSHADER_REQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='appid',
            full_name='CShader_SendShader_Request.appid',
            index=0,
            number=1,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name='shaders',
            full_name='CShader_SendShader_Request.shaders',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
    ...
    extensions=[],
    nested_types=[
        _CSHADER_SENDSHADER_REQUEST_SHADERCODE,
    ],
    enum_types=[],
    serialized_options=None,
    is_extendable=False,
...
_CSHADER_GETBUCKETMANIFEST_REQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='appid',
            full_name='CShader_GetBucketManifest_Request.appid',
            index=0,
            number=1,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name='gpu_desc',
            full_name='CShader_GetBucketManifest_Request.gpu_desc',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='driver_desc',
            full_name='CShader_GetBucketManifest_Request.driver_desc',
            index=2,
            number=3,
            type=9,
            cpp_type=9,
...
_CSHADER_GETBUCKETMANIFEST_RESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='manifestid',
            full_name='CShader_GetBucketManifest_Response.manifestid',
            index=0,
            number=1,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name='depotsize',
            full_name='CShader_GetBucketManifest_Response.depotsize',
            index=1,
            number=2,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name='bucketid',
            full_name='CShader_GetBucketManifest_Response.bucketid',
            index=2,
            number=3,
            type=4,
            cpp_type=4,
...
_CSHADER_GETSTALEBUCKET_REQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='gpu_desc',
            full_name='CShader_GetStaleBucket_Request.gpu_desc',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='driver_desc',
            full_name='CShader_GetStaleBucket_Request.driver_desc',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_CSHADER_GETSTALEBUCKET_RESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='bucketid',
            full_name='CShader_GetStaleBucket_Response.bucketid',
            index=0,
            number=1,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name='appid',
            full_name='CShader_GetStaleBucket_Response.appid',
            index=1,
            number=2,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name='manifestid',
            full_name='CShader_GetStaleBucket_Response.manifestid',
            index=2,
            number=3,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name='gpu_desc',
            full_name='CShader_GetStaleBucket_Response.gpu_desc',
            index=3,
            number=4,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='driver_desc',
            full_name='CShader_GetStaleBucket_Response.driver_desc',
            index=4,
            number=5,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='CShader_GetStaleBucket_Response.depot_encryption_key',
            index=5,
            number=6,
            type=12,
            cpp_type=9,
...
_CSHADER_REPORTEXTERNALBUILD_REQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='appid',
            full_name='CShader_ReportExternalBuild_Request.appid',
            index=0,
            number=1,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name='gpu_desc',
            full_name='CShader_ReportExternalBuild_Request.gpu_desc',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='driver_desc',
            full_name='CShader_ReportExternalBuild_Request.driver_desc',
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='manifestid',
            full_name='CShader_ReportExternalBuild_Request.manifestid',
            index=3,
            number=4,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name='source_gpu_desc',
            full_name='CShader_ReportExternalBuild_Request.source_gpu_desc',
            index=4,
            number=5,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='source_driver_desc',
            full_name='CShader_ReportExternalBuild_Request.source_driver_desc',
            index=5,
            number=6,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='depotsize',
            full_name='CShader_ReportExternalBuild_Request.depotsize',
            index=6,
            number=7,
            type=4,
            cpp_type=4,
...
_CSHADER_REGISTERSHADER_REQUEST.fields_by_name[
    'shaders'
].message_type = _CSHADER_REGISTERSHADER_REQUEST_SHADER
_CSHADER_SENDSHADER_REQUEST_SHADERCODE.containing_type = _CSHADER_SENDSHADER_REQUEST
_CSHADER_SENDSHADER_REQUEST.fields_by_name[
    'shaders'
].message_type = _CSHADER_SENDSHADER_REQUEST_SHADERCODE
DESCRIPTOR.message_types_by_name['CShader_RegisterShader_Request'] = _CSHADER_REGISTERSHADER_REQUEST
DESCRIPTOR.message_types_by_name['CShader_RegisterShader_Response'] = (
    _CSHADER_REGISTERSHADER_RESPONSE
)
...
DESCRIPTOR.message_types_by_name['CShader_GetBucketManifest_Request'] = (
    _CSHADER_GETBUCKETMANIFEST_REQUEST
)
DESCRIPTOR.message_types_by_name['CShader_GetBucketManifest_Response'] = (
    _CSHADER_GETBUCKETMANIFEST_RESPONSE
)
...
DESCRIPTOR.message_types_by_name['CShader_GetStaleBucket_Response'] = (
    _CSHADER_GETSTALEBUCKET_RESPONSE
)
DESCRIPTOR.message_types_by_name['CShader_ReportExternalBuild_Request'] = (
    _CSHADER_REPORTEXTERNALBUILD_REQUEST
)
DESCRIPTOR.message_types_by_name['CShader_ReportExternalBuild_Response'] = (
    _CSHADER_REPORTEXTERNALBUILD_RESPONSE
)
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

CShader_RegisterShader_Request = _reflection.GeneratedProtocolMessageType(
    'CShader_RegisterShader_Request',
    (_message.Message,),
    {
        'Shader': _reflection.GeneratedProtocolMessageType(
            'Shader',
            (_message.Message,),
            {
...
CShader_RegisterShader_Response = _reflection.GeneratedProtocolMessageType(
...
CShader_SendShader_Request = _reflection.GeneratedProtocolMessageType(
    'CShader_SendShader_Request',
    (_message.Message,),
    {
        'ShaderCode': _reflection.GeneratedProtocolMessageType(
            'ShaderCode',
            (_message.Message,),
            {
...
CShader_SendShader_Response = _reflection.GeneratedProtocolMessageType(
...
CShader_GetBucketManifest_Request = _reflection.GeneratedProtocolMessageType(
...
CShader_GetBucketManifest_Response = _reflection.GeneratedProtocolMessageType(
...
CShader_GetStaleBucket_Request = _reflection.GeneratedProtocolMessageType(
...
CShader_GetStaleBucket_Response = _reflection.GeneratedProtocolMessageType(
...
CShader_ReportExternalBuild_Request = _reflection.GeneratedProtocolMessageType(
...
CShader_ReportExternalBuild_Response = _reflection.GeneratedProtocolMessageType(
