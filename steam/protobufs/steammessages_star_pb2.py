...
_E_STAR_GLYPHWRITERESULT = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name='k_E_STAR_GlyphWriteResult_Success',
            index=0,
            number=0,
...
_CSTAR_KEYVALUEQUERY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='key',
            full_name='CSTAR_KeyValueQuery.key',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
            ...
            serialized_options=b'\202\265\0302key to search for in JSON path format (SQL subset)',
            file=DESCRIPTOR,
            create_key=_descriptor._internal_create_key,
        ),
        _descriptor.FieldDescriptor(
            name='value',
            full_name='CSTAR_KeyValueQuery.value',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
            ...
            is_extension=False,
            extension_scope=None,
            serialized_options=b'\202\265\030Wthe value to compare against (the JSON value will be compared for equality as a string)',
            file=DESCRIPTOR,
            create_key=_descriptor._internal_create_key,
        ),
    ],
...
_CSTAR_GLYPHQUERYPARAMS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='bundle_id',
            full_name='CSTAR_GlyphQueryParams.bundle_id',
            index=0,
            number=1,
            type=4,
            cpp_type=4,
            ...
            is_extension=False,
            extension_scope=None,
            serialized_options=b'\202\265\030\\if provided, Bundle ID is used instead of the other query parameters (much faster SQL query)',
            file=DESCRIPTOR,
            create_key=_descriptor._internal_create_key,
        ),
        _descriptor.FieldDescriptor(
            name='queries',
            full_name='CSTAR_GlyphQueryParams.queries',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
            ...
            is_extension=False,
            extension_scope=None,
            serialized_options=b'\202\265\030\021key value queries',
            file=DESCRIPTOR,
            create_key=_descriptor._internal_create_key,
        ),
    ],
...
_CSTAR_READGLYPHDATA_REQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='query_params',
            full_name='CSTAR_ReadGlyphData_Request.query_params',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
            ...
            is_extension=False,
            extension_scope=None,
            serialized_options=b'\202\265\0302parameters to identify the glyphs to read from SQL',
            file=DESCRIPTOR,
            create_key=_descriptor._internal_create_key,
        ),
        _descriptor.FieldDescriptor(
            name='last_modified_time_lower_limit',
            full_name='CSTAR_ReadGlyphData_Request.last_modified_time_lower_limit',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
            ...
            is_extension=False,
            extension_scope=None,
            serialized_options=b'\202\265\030aif provided, only return glyphs modified more recently than this timestamp  (RFC 3339 UTC format)',
            file=DESCRIPTOR,
            create_key=_descriptor._internal_create_key,
        ),
    ],
...
_CSTAR_GLYPHDATA = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='glyph_guid',
            full_name='CSTAR_GlyphData.glyph_guid',
            index=0,
            number=1,
            type=12,
            cpp_type=9,
            ...
            is_extension=False,
            extension_scope=None,
            serialized_options=b'\202\265\030$GUID uniquely identifying this glyph',
            file=DESCRIPTOR,
            create_key=_descriptor._internal_create_key,
        ),
        _descriptor.FieldDescriptor(
            name='glyph_last_modified',
            full_name='CSTAR_GlyphData.glyph_last_modified',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
            ...
            is_extension=False,
            extension_scope=None,
            serialized_options=b'\202\265\030Dtimestamp of when this glyph was last modified (RFC 3339 UTC format)',
            file=DESCRIPTOR,
            create_key=_descriptor._internal_create_key,
        ),
        _descriptor.FieldDescriptor(
            name='glyph_json_data',
            full_name='CSTAR_GlyphData.glyph_json_data',
            index=2,
            number=3,
            type=9,
            cpp_type=9,
            ...
            is_extension=False,
            extension_scope=None,
            serialized_options=b'\202\265\030\027JSON encoded glyph data',
            file=DESCRIPTOR,
            create_key=_descriptor._internal_create_key,
        ),
    ],
...
_CSTAR_WRITEGLYPHDATA_REQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='bundle_id',
            full_name='CSTAR_WriteGlyphData_Request.bundle_id',
            index=0,
            number=1,
            type=4,
            cpp_type=4,
            ...
            is_extension=False,
            extension_scope=None,
            serialized_options=b'\202\265\030)the Bundle ID of the glyphs to be written',
            file=DESCRIPTOR,
            create_key=_descriptor._internal_create_key,
        ),
        _descriptor.FieldDescriptor(
            name='glyph_data',
            full_name='CSTAR_WriteGlyphData_Request.glyph_data',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
            ...
            is_extension=False,
            extension_scope=None,
            serialized_options=b'\202\265\030(one or more items of glyph data to write',
            file=DESCRIPTOR,
            create_key=_descriptor._internal_create_key,
        ),
    ],
...
_CSTAR_REQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='read_glyph_data',
            full_name='CSTAR_Request.read_glyph_data',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='write_glyph_data',
            full_name='CSTAR_Request.write_glyph_data',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_CSTAR_READGLYPHDATA_RESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='bundle_id',
            full_name='CSTAR_ReadGlyphData_Response.bundle_id',
            index=0,
            number=1,
            type=4,
            cpp_type=4,
            ...
            is_extension=False,
            extension_scope=None,
            serialized_options=b'\202\265\030ethe Bundle ID of the returned glyphs; the client should send this back to optimize subsequent queries',
            file=DESCRIPTOR,
            create_key=_descriptor._internal_create_key,
        ),
        _descriptor.FieldDescriptor(
            name='glyph_data',
            full_name='CSTAR_ReadGlyphData_Response.glyph_data',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
            ...
            is_extension=False,
            extension_scope=None,
            serialized_options=b'\202\265\030)zero or more items of returned glyph data',
            file=DESCRIPTOR,
            create_key=_descriptor._internal_create_key,
        ),
    ],
...
_CSTAR_WRITEGLYPHDATA_RESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='result',
            full_name='CSTAR_WriteGlyphData_Response.result',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
            ...
            is_extension=False,
            extension_scope=None,
            serialized_options=b'\202\265\030(write result for each item of glyph data',
            file=DESCRIPTOR,
            create_key=_descriptor._internal_create_key,
        ),
    ],
...
_CSTAR_RESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='read_glyph_data',
            full_name='CSTAR_Response.read_glyph_data',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='write_glyph_data',
            full_name='CSTAR_Response.write_glyph_data',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
CSTAR_KeyValueQuery = _reflection.GeneratedProtocolMessageType(
    'CSTAR_KeyValueQuery',
    (_message.Message,),
    {
...
CSTAR_GlyphQueryParams = _reflection.GeneratedProtocolMessageType(
...
CSTAR_ReadGlyphData_Request = _reflection.GeneratedProtocolMessageType(
...
CSTAR_GlyphData = _reflection.GeneratedProtocolMessageType(
    'CSTAR_GlyphData',
    (_message.Message,),
    {
...
CSTAR_WriteGlyphData_Request = _reflection.GeneratedProtocolMessageType(
...
CSTAR_Request = _reflection.GeneratedProtocolMessageType(
    'CSTAR_Request',
    (_message.Message,),
    {
...
CSTAR_ReadGlyphData_Response = _reflection.GeneratedProtocolMessageType(
...
CSTAR_WriteGlyphData_Response = _reflection.GeneratedProtocolMessageType(
...
CSTAR_Response = _reflection.GeneratedProtocolMessageType(
    'CSTAR_Response',
    (_message.Message,),
    {
...
STAR = service_reflection.GeneratedServiceType(
    'STAR',
    (_service.Service,),
    dict(DESCRIPTOR=_STAR, __module__='steammessages_star_pb2'),
)

STAR_Stub = service_reflection.GeneratedServiceStubType(
    'STAR_Stub', (STAR,), dict(DESCRIPTOR=_STAR, __module__='steammessages_star_pb2')
)
