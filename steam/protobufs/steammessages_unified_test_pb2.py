...
_CMSGTEST_MESSAGETOCLIENT_REQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='some_text',
            full_name='CMsgTest_MessageToClient_Request.some_text',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
            ...
            serialized_options=b'\202\265\030\014Some string.',
            file=DESCRIPTOR,
            create_key=_descriptor._internal_create_key,
        ),
    ],
...
_CMSGTEST_MESSAGETOCLIENT_RESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='some_text',
            full_name='CMsgTest_MessageToClient_Response.some_text',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_CMSGTEST_NOTIFYCLIENT_NOTIFICATION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='some_text',
            full_name='CMsgTest_NotifyClient_Notification.some_text',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_CMSGTEST_MESSAGETOSERVER_REQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='some_text',
            full_name='CMsgTest_MessageToServer_Request.some_text',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_CMSGTEST_MESSAGETOSERVER_RESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='some_text',
            full_name='CMsgTest_MessageToServer_Response.some_text',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_CMSGTEST_NOTIFYSERVER_NOTIFICATION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='some_text',
            full_name='CMsgTest_NotifyServer_Notification.some_text',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
DESCRIPTOR.message_types_by_name['CMsgTest_MessageToClient_Request'] = (
    _CMSGTEST_MESSAGETOCLIENT_REQUEST
)
DESCRIPTOR.message_types_by_name['CMsgTest_MessageToClient_Response'] = (
    _CMSGTEST_MESSAGETOCLIENT_RESPONSE
)
DESCRIPTOR.message_types_by_name['CMsgTest_NotifyClient_Notification'] = (
    _CMSGTEST_NOTIFYCLIENT_NOTIFICATION
)
DESCRIPTOR.message_types_by_name['CMsgTest_MessageToServer_Request'] = (
    _CMSGTEST_MESSAGETOSERVER_REQUEST
)
DESCRIPTOR.message_types_by_name['CMsgTest_MessageToServer_Response'] = (
    _CMSGTEST_MESSAGETOSERVER_RESPONSE
)
DESCRIPTOR.message_types_by_name['CMsgTest_NotifyServer_Notification'] = (
    _CMSGTEST_NOTIFYSERVER_NOTIFICATION
)
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

CMsgTest_MessageToClient_Request = _reflection.GeneratedProtocolMessageType(
...
CMsgTest_MessageToClient_Response = _reflection.GeneratedProtocolMessageType(
...
CMsgTest_NotifyClient_Notification = _reflection.GeneratedProtocolMessageType(
...
CMsgTest_MessageToServer_Request = _reflection.GeneratedProtocolMessageType(
...
CMsgTest_MessageToServer_Response = _reflection.GeneratedProtocolMessageType(
...
CMsgTest_NotifyServer_Notification = _reflection.GeneratedProtocolMessageType(
...
TestSteamClient = service_reflection.GeneratedServiceType(
    'TestSteamClient',
    (_service.Service,),
    dict(DESCRIPTOR=_TESTSTEAMCLIENT, __module__='steammessages_unified_test_pb2'),
)

TestSteamClient_Stub = service_reflection.GeneratedServiceStubType(
...
TestServerFromClient = service_reflection.GeneratedServiceType(
    'TestServerFromClient',
    (_service.Service,),
    dict(DESCRIPTOR=_TESTSERVERFROMCLIENT, __module__='steammessages_unified_test_pb2'),
)

TestServerFromClient_Stub = service_reflection.GeneratedServiceStubType(
