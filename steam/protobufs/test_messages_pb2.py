...
_COMPLEXPROTOMESSAGE_INNERMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='text',
            full_name='ComplexProtoMessage.InnerMessage.text',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='numbers',
            full_name='ComplexProtoMessage.InnerMessage.numbers',
            index=1,
            number=2,
            type=13,
            cpp_type=3,
...
_COMPLEXPROTOMESSAGE_INNERBUFFER_FLAGS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='flag',
            full_name='ComplexProtoMessage.InnerBuffer.Flags.flag',
            index=0,
            number=1,
            type=8,
            cpp_type=7,
...
_COMPLEXPROTOMESSAGE_INNERBUFFER = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='data',
            full_name='ComplexProtoMessage.InnerBuffer.data',
            index=0,
            number=1,
            type=12,
            cpp_type=9,
    ...
    extensions=[],
    nested_types=[
        _COMPLEXPROTOMESSAGE_INNERBUFFER_FLAGS,
    ],
    enum_types=[],
    serialized_options=None,
    is_extendable=False,
...
_COMPLEXPROTOMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='number32',
            full_name='ComplexProtoMessage.number32',
            index=0,
            number=1,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name='number64',
            full_name='ComplexProtoMessage.number64',
            index=1,
            number=2,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name='list_number32',
            full_name='ComplexProtoMessage.list_number32',
            index=2,
            number=3,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name='list_number64',
            full_name='ComplexProtoMessage.list_number64',
            index=3,
            number=4,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name='messages',
            full_name='ComplexProtoMessage.messages',
            index=4,
            number=5,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='buffers',
            full_name='ComplexProtoMessage.buffers',
            index=5,
            number=6,
            type=11,
            cpp_type=10,
    ...
    nested_types=[
        ...
        _COMPLEXPROTOMESSAGE_INNERBUFFER,
    ],
    enum_types=[],
    serialized_options=None,
    is_extendable=False,
...
_COMPLEXPROTOMESSAGE_INNERBUFFER.fields_by_name[
    'flags'
].message_type = _COMPLEXPROTOMESSAGE_INNERBUFFER_FLAGS
...
ComplexProtoMessage = _reflection.GeneratedProtocolMessageType(
    'ComplexProtoMessage',
    (_message.Message,),
    {
        'InnerMessage': _reflection.GeneratedProtocolMessageType(
            'InnerMessage',
            (_message.Message,),
            {
        ...
        'InnerBuffer': _reflection.GeneratedProtocolMessageType(
            'InnerBuffer',
            (_message.Message,),
            {
                'Flags': _reflection.GeneratedProtocolMessageType(
                    'Flags',
                    (_message.Message,),
                    {
